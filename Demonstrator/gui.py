...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.slider1 = customtkinter.CTkSlider(self, from_=81.747, to=155.032, variable=self.slider1var, command=update_label1)
        ...
        self.slider2 = customtkinter.CTkSlider(self, from_=78.409, to=82.159, variable=self.slider2var, command=update_label2)
        ...
        self.slider3 = customtkinter.CTkSlider(self, from_=6.084, to=11.232, variable=self.slider3var, command=update_label3)
        ...
        self.slider4 = customtkinter.CTkSlider(self, from_=2.78, to=6.61, variable=self.slider4var, command=update_label4)
        ...
        self.slider5 = customtkinter.CTkSlider(self, from_=74.78, to=75.79, variable=self.slider5var, command=update_label5)
        ...
        self.slider6 = customtkinter.CTkSlider(self, from_=876.7, to=930.6, variable=self.slider6var, command=update_label6)
        ...
        self.slider7 = customtkinter.CTkSlider(self, from_=894.8, to=946.5, variable=self.slider7var, command=update_label7)
        ...
        self.slider8 = customtkinter.CTkSlider(self, from_=94.2, to=130.3, variable=self.slider8var, command=update_label8)
        ...
        self.slider9 = customtkinter.CTkSlider(self, from_=76.5, to=114.9, variable=self.slider9var, command=update_label9)
        ...
        self.slider10 = customtkinter.CTkSlider(self, from_=144.8, to=155.5, variable=self.slider10var, command=update_label10)
        ...
        self.slider11 = customtkinter.CTkSlider(self, from_=780.5, to=943, variable=self.slider11var, command=update_label11)
        ...
        self.slider12 = customtkinter.CTkSlider(self, from_=8.33, to=9.06, variable=self.slider12var, command=update_label12)
        ...
        self.slider13 = customtkinter.CTkSlider(self, from_=18.51, to=19.23, variable=self.slider13var, command=update_label13)
