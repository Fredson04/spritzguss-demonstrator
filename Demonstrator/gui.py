...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        def update_label1(value):
            self.amount1label.configure(text=f"{value:.4f}")
        def update_label2(value):
            self.amount2label.configure(text=f"{value:.4f}")
        def update_label3(value):
            self.amount3label.configure(text=f"{value:.4f}")
        def update_label4(value):
            self.amount4label.configure(text=f"{value:.4f}")
        def update_label5(value):
            self.amount5label.configure(text=f"{value:.4f}")
        def update_label6(value):
            self.amount6label.configure(text=f"{value:.4f}")
        def update_label7(value):
            self.amount7label.configure(text=f"{value:.4f}")
        def update_label8(value):
            self.amount8label.configure(text=f"{value:.4f}")
        def update_label9(value):
            self.amount9label.configure(text=f"{value:.4f}")
        def update_label10(value):
            self.amount10label.configure(text=f"{value:.4f}")
        def update_label11(value):
            self.amount11label.configure(text=f"{value:.4f}")
        def update_label12(value):
            self.amount12label.configure(text=f"{value:.4f}")
        def update_label13(value):
            self.amount13label.configure(text=f"{value:.4f}")
        ...
        self.amount1label = customtkinter.CTkLabel(self, text=f"{(self.slider1var.get()):.4f}", fg_color="transparent")
        ...
        self.amount2label = customtkinter.CTkLabel(self, text=f"{(self.slider2var.get()):.4f}", fg_color="transparent")
        ...
        self.amount3label = customtkinter.CTkLabel(self, text=f"{(self.slider3var.get()):.4f}", fg_color="transparent")
        ...
        self.amount4label = customtkinter.CTkLabel(self, text=f"{(self.slider4var.get()):.4f}", fg_color="transparent")
        ...
        self.amount5label = customtkinter.CTkLabel(self, text=f"{(self.slider5var.get()):.4f}", fg_color="transparent")
        ...
        self.amount6label = customtkinter.CTkLabel(self, text=f"{(self.slider6var.get()):.4f}", fg_color="transparent")
        ...
        self.amount7label = customtkinter.CTkLabel(self, text=f"{(self.slider7var.get()):.4f}", fg_color="transparent")
        ...
        self.amount8label = customtkinter.CTkLabel(self, text=f"{(self.slider8var.get()):.4f}", fg_color="transparent")
        ...
        self.amount9label = customtkinter.CTkLabel(self, text=f"{(self.slider9var.get()):.4f}", fg_color="transparent")
        ...
        self.amount10label = customtkinter.CTkLabel(self, text=f"{(self.slider10var.get()):.4f}", fg_color="transparent")
        ...
        self.amount11label = customtkinter.CTkLabel(self, text=f"{(self.slider11var.get()):.4f}", fg_color="transparent")
        ...
        self.amount12label = customtkinter.CTkLabel(self, text=f"{(self.slider12var.get()):.4f}", fg_color="transparent")
        ...
        self.amount13label = customtkinter.CTkLabel(self, text=f"{(self.slider13var.get()):.4f}", fg_color="transparent")
    ...
    def useOptimizedFunc(self):
        ...
        self.amount1label.configure(text=f"{(self.transformed_solution)[0]:.4f}")
        self.slider2.set((self.transformed_solution)[1])
        self.amount2label.configure(text=f"{(self.transformed_solution)[1]:.4f}")
        self.slider3.set((self.transformed_solution)[2])
        self.amount3label.configure(text=f"{(self.transformed_solution)[2]:.4f}")
        self.slider4.set((self.transformed_solution)[3])
        self.amount4label.configure(text=f"{(self.transformed_solution)[3]:.4f}")
        self.slider5.set((self.transformed_solution)[4])
        self.amount5label.configure(text=f"{(self.transformed_solution)[4]:.4f}")
        self.slider6.set((self.transformed_solution)[5])
        self.amount6label.configure(text=f"{(self.transformed_solution)[5]:.4f}")
        self.slider7.set((self.transformed_solution)[6])
        self.amount7label.configure(text=f"{(self.transformed_solution)[6]:.4f}")
        self.slider8.set((self.transformed_solution)[7])
        self.amount8label.configure(text=f"{(self.transformed_solution)[7]:.4f}")
        self.slider9.set((self.transformed_solution)[8])
        self.amount9label.configure(text=f"{(self.transformed_solution)[8]:.4f}")
        self.slider10.set((self.transformed_solution)[9])
        self.amount10label.configure(text=f"{(self.transformed_solution)[9]:.4f}")
        self.slider11.set((self.transformed_solution)[10])
        self.amount11label.configure(text=f"{(self.transformed_solution)[10]:.4f}")
        self.slider12.set((self.transformed_solution)[11])
        self.amount12label.configure(text=f"{(self.transformed_solution)[11]:.4f}")
        self.slider13.set((self.transformed_solution)[12])
        self.amount13label.configure(text=f"{(self.transformed_solution)[12]:.4f}")
